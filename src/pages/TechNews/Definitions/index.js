...
export default function TechNewsDefinitions({ navigation }) {
  ...
  const handleOpenModal = useCallback(({ title, options, identifier, iconName = '', message = '' }) => {
    if (!message) {
  ...
  const handleChangeDefinition = useCallback(({ name, value }) => {
    setPromptVisible(false);
    updateDefinition({ name, value });
    //console.log(`->${name}:${value}`, definitions[name]);
  }, [definitions]);
  ...
  return (
    <Container style={{ backgroundColor: '#FFF' }}>
      <ScrollView style={{ paddingTop: 10, paddingBottom: 60, paddingHorizontal: 16 }}>
        ...
        <Fieldset>
          ...
          <Definition onPress={() => handleOpenModal({ ...appearance.dimensionCaracterArticle })}>
            ...
            <Description>{currentDescription[appearance.dimensionCaracterArticle.identifier]}</Description>
          </Definition>
        ...
        <Fieldset>
          ...
          <DefinitionSwitch>
            <AsideSwitch>
              ...
              <Description>Fazer com que a primeira aba mostre as notícias mais recentes de todos os sites ativos</Description>
            </AsideSwitch>
            <SwitchStyled isEnabled={definitions[general.recent.identifier]}
              onValueChange={() => handleChangeDefinition({
          ...
          <DefinitionSwitch>
            ...
            <SwitchStyled isEnabled={definitions[general.exit.identifier]}
              onValueChange={() => handleChangeDefinition({
          ...
          <DefinitionSwitch>
            ...
            <SwitchStyled isEnabled={definitions[general.active.identifier]}
              onValueChange={() => handleChangeDefinition({
          ...
          <DefinitionSwitch>
            ...
            <SwitchStyled isEnabled={definitions[general.fullscreen.identifier]}
              onValueChange={() => handleChangeDefinition({
          ...
          <DefinitionSwitch>
            ...
            <SwitchStyled isEnabled={definitions[general.adverts.identifier]}
              onValueChange={() => handleChangeDefinition({
          ...
          <DefinitionSwitch>
            <AsideSwitch>
              ...
              <Description>Melhore a estabilidade da aplicação desativando a aceleração gráfica de hardware</Description>
            </AsideSwitch>
            <SwitchStyled isEnabled={definitions[general.acceleration.identifier]}
              onValueChange={() => handleChangeDefinition({
          ...
          <DefinitionSwitch>
            ...
            <SwitchStyled isEnabled={definitions[general.mobile.identifier]}
              onValueChange={() => handleChangeDefinition({
        ...
        <Fieldset>
          ...
          <Definition onPress={() => handleOpenModal({ ...cache.clearNow }, { ...cache.clearNow })}>
      ...
      <ModalPrompt
        ...
        currentValue={definitions[identifierPrompt]}
      ...
      <ModalConfirm
        ...
        onConfirm={() => handleConfirm[identifierPrompt]()}
      />
